...
class TroostwatchHttpClient:
    ...
    def authenticate(self, *, force: bool = False) -> None:
        ...
        1) Use a cached token file when configured and not expired.
        2) Reuse an existing in-memory session when still valid.
        3) Perform a credential-based login using provided username/password.
        """
    ...
    def _login(self, username: str, password: str) -> None:
        ...
        # First fetch the login page to obtain a CSRF token if required
