# APM 0.5.1 - Task Assignment Guide
...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.github/prompts/apm-8-delegate-debug.prompt.md or .github/prompts/apm-7-delegate-research.prompt.md)]
```
...
## 5. Memory Log Review
When Implementation Agent returns, **review Memory Log per .apm/guides/Memory_Log_Guide.md section §5**. Assess task completion status, identify blockers, and verify outputs match Implementation Plan expectations.
...
- **Debug Delegation**: Reference .github/prompts/apm-8-delegate-debug.prompt.md
- **Research Delegation**: Reference .github/prompts/apm-7-delegate-research.prompt.md  
