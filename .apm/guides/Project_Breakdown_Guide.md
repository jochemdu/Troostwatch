...
**Content Definition:**
- If flagged in §4.1, first add an ad-hoc delegation step: "Ad-Hoc Delegation – <purpose>" (optional ref to .github/prompts/apm-7-delegate-research.prompt.md or .github/prompts/apm-8-delegate-debug.prompt.md), then continue
