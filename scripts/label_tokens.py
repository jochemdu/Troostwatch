...
def classify_token(text: str, context: list[str] | None = None) -> str:
    ...
    common_words = {
        ...
        "NOT", "BUT", "ALL", "CAN", "HER", "WAS", "ONE", "OUR", "OUT",
        "COMPLIANCE", "MANUFACTURED", "TECHNOLOGY", "TECHNOLOGIE", "MARKS",
        "MADE", "CHINA", "TAIWAN", "DESIGNED", "ASSEMBLED", "PRINTED",
        "WARNING", "CAUTION", "ATTENTION", "PRODUCT", "DEVICE", "EQUIPMENT",
        "COMPUTER", "LAPTOP", "NOTEBOOK", "PORTABLE", "ORDINATEUR",
        "INFORMATION", "SPECIFICATION", "SPECIFICATIONS", "GRAPHICS",
        "PROCESSOR", "MEMORY", "STORAGE", "DISPLAY", "SCREEN", "KEYBOARD",
        "SOFTWARE", "HARDWARE", "SYSTEM", "WINDOWS", "LINUX", "MACOS",
        "ONTWIKKELD", "PRESTATIES", "BEPAALDE", "SOFTWAREPRODUCTEN",
        "SOFTWAREAPPLICATIES", "NOODZAKELIJKERWIJS", "KLOKFREQUENTIE",
        "AFNANKELIJK", "MERKNAAM", "CODE", "WLAN", "KEY", "PO", "ATTN",
        "INS", "STY", "CASE", "NIA"
    }
    ...
    brands = [
        ...
        "IDEAPAD", "PAVILION", "INSPIRON", "VOSTRO", "PRECISION"
    ]
